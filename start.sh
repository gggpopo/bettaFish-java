...
# 启动主应用
echo ""
echo "[3/3] 启动 BettaFish 主应用 (端口 2001)..."
echo ""
echo "========================================="
echo "  API 端点:"
echo "  POST http://localhost:2001/api/analysis"
echo "  GET  http://localhost:2001/api/analysis/{taskId}"
echo "  GET  http://localhost:2001/api/analysis/{taskId}/events (SSE)"
echo ""
echo "  测试命令:"
echo "  curl -X POST http://localhost:2001/api/analysis \\"
